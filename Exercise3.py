...
class Weapon:
    ...
    def __init__(self):
        # Weapons list
        weapons = ["Rope", "Candlestick", "Lead Pipe", "Pistol", "M-16", "AK47"]
        # Creating weapon variable and assigning a random weapon from the weapons list
        self.weapon = random.choice(weapons)

    # get weapon function which returns selected weapon
    def get_weapon(self):
        return self.weapon
...
class Suspect:
    ...
    def __init__(self):
        ...
        # Weapon variable which is composite of class Weapon
        self.weapon = Weapon()
...
class Player:
    ...
    def display(self):
        ...
        print("Location: ", self.character.location.get_current_location(), "(", self.character.weapon.get_weapon(),
              ")")
